...
public:
    ...
    static sj_token_t parseToken(std::istream & fs, char * string);
    static GenExpr ** parse_prefix_args(std::istream & fs, int num_args, MilkdropPreset * preset);
    static GenExpr * parse_infix_op(std::istream & fs, sj_token_t token, TreeExpr * tree_expr, MilkdropPreset * preset);
