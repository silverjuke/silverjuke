...
#define SJ_VERSION_MAJOR    16      // when changing the version number here, also change it in configure.ac and maybe in the OS-depending installer
#define SJ_VERSION_MINOR    5
