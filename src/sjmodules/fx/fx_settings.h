...
#ifndef __SJ_FX_SETTINGS_H__
#define __SJ_FX_SETTINGS_H__


class SjFxSettingsModule : public SjCommonModule
{
public:
	                SjFxSettingsModule   (SjInterfaceBase*);
